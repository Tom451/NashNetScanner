            ...
            <div class="collapse show item-2" role="tabpanel" data-parent="#accordion-1">
                <div class="card-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                <p>Right now that is out of the way, the second part is to create a scan. This is important as it will show where the vulnerabilities are located on the network, please begin by starting a scan below:&nbsp; &nbsp;</p><form action="/scan/Create/CreateScan.php" method="post"><button class="btn btn-primary" type="submit" name="createScan" value="NetDisc">Run Discovery</button></form>
                            </div>
